  ...
  <body>
    <header>
      ...
      <nav class="navbar">
        ...
        <!--/////////////////////////////////////// action //////////////////////////////////////////////////-->
        <div class="action">
            <a style="text-decoration: none" href="./myInfo2.php">Hồ sơ của tôi</a><i class='bx bx-user-circle'></i>
        </div>
      </nav>
      <div class="action">
            <a href="#">Hồ sơ của tôi</a><i class='bx bx-user-circle'></i>
        </div>
      </nav>
...
<body>
  ...
  <div class="slide" style= "display: flex;justify-content:center; align-item:center;margin-top:100px">
